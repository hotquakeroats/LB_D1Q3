...
plot "eigenstuff_tcA0.450000_tcB0.450000_aA0.506250_aAB0.285322_aB0.506250.dat" using ($4<=0 ? $1 : 1/0):2:(scale*$6/vnorm($6,1)):(scale/vnorm($6,1)) with vectors linecolor rgb "red" notitle, \
 ...
 "threePhaseDiagram-densities-twoPhases_tcA0.450000_tcB0.450000_aA0.506250_aAB0.285322_aB0.506250.dat" using 1:2 with points pointtype 13 linecolor rgb 'light-grey' title "Minimization 2-phase Test Point", \
 "threePhaseDiagram-densities-threePhases_tcA0.450000_tcB0.450000_aA0.506250_aAB0.285322_aB0.506250.dat" using 1:2 with points pointtype 13 linecolor rgb 'dark-grey' title "Minimization 3-phase Test Point", \
