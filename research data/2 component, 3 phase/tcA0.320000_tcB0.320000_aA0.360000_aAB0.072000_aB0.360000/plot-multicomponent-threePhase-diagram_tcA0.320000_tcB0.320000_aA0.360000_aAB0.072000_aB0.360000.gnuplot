...
plot "threePhaseDiagram-densities-twoPhases_tcA0.320000_tcB0.320000_aA0.360000_aAB0.072000_aB0.360000.dat" using 1:2 with points pointtype 13 lc rgb 'light-grey' title "Minimization 2-phase Test Point", \
 ...
 "LB-two-phase-region_tcA0.320000_tcB0.320000_aA0.360000_aAB0.072000_aB0.360000.dat" using 1:2 with points pointtype 7 lc rgb 'blue' title "LB 2-phase region (log)", \
 ...
 "LB-three-phase-region_tcA0.320000_tcB0.320000_aA0.360000_aAB0.072000_aB0.360000.dat" using 1:2 with points pointtype 7 lc rgb 'gold' title "LB 3-phase region", \
 "singularity-line-coords_tcA0.320000_tcB0.320000_aA0.360000_aAB0.072000_aB0.360000.dat" with lines lc rgb 'black' notitle


#"LB-metastable-3-phase-region_tcA0.320000_tcB0.320000_aA0.360000_aAB0.072000_aB0.360000.dat" using 1:2 with points pointtype 7 lc rgb 'red' title "LB metastable region (3-phase)", \
