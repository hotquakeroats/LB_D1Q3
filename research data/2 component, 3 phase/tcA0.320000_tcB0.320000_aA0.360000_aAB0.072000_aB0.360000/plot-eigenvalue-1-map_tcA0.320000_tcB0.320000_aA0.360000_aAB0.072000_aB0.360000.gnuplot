...
set size square
set grid
stats "eigenstuff_tcA0.320000_tcB0.320000_aA0.360000_aAB0.072000_aB0.360000.dat" using 4
...
plot "eigenstuff_tcA0.320000_tcB0.320000_aA0.360000_aAB0.072000_aB0.360000.dat" using 1:2:($4<0 ? -1*log(abs($4)+1) : log(abs($4)+1)) with points pointtype 7 pointsize 1.5 palette title "Eigenvalue 1", \
