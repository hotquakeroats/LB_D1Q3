...
set size square
set grid
stats "eigenstuff_tcA0.500000_tcB0.300000_aA0.562500_aAB0.397748_aB0.281250.dat" using 4
...
plot "eigenstuff_tcA0.500000_tcB0.300000_aA0.562500_aAB0.397748_aB0.281250.dat" using 1:2:($4<0 ? -1*log(abs($4)+1) : log(abs($4)+1)) with points pointtype 7 pointsize 1.5 palette title "Eigenvalue 1", \
