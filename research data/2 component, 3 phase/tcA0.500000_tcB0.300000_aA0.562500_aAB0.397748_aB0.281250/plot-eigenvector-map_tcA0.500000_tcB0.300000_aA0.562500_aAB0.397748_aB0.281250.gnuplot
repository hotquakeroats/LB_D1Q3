...
plot "eigenstuff_tcA0.500000_tcB0.300000_aA0.562500_aAB0.397748_aB0.281250.dat" using ($4<=0 ? $1 : 1/0):2:(scale*$6/vnorm($6,1)):(scale/vnorm($6,1)) with vectors lc rgb "red" notitle, \
 "eigenstuff_tcA0.500000_tcB0.300000_aA0.562500_aAB0.397748_aB0.281250.dat" using ($4>0 ? $1 : 1/0):2:(scale*$6/vnorm($6,1)):(scale/vnorm($6,1)) with vectors lc rgb "blue" notitle, \
 "eigenstuff_tcA0.500000_tcB0.300000_aA0.562500_aAB0.397748_aB0.281250.dat" using ($5<=0 ? $1 : 1/0):2:(scale*$7/vnorm($7,1)):(scale/vnorm($7,1)) with vectors lc rgb "red" notitle, \
 "eigenstuff_tcA0.500000_tcB0.300000_aA0.562500_aAB0.397748_aB0.281250.dat" using ($5>0 ? $1 : 1/0):2:(scale*$7/vnorm($7,1)):(scale/vnorm($7,1)) with vectors lc rgb "blue" notitle, \
