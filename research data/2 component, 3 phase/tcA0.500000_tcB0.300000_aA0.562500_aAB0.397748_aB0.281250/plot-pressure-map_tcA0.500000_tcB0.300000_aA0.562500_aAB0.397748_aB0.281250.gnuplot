...
set size square
set grid
stats "pressure-deviations_tcA0.500000_tcB0.300000_aA0.562500_aAB0.397748_aB0.281250.dat" using 3
set cbrange [STATS_max/100:STATS_max]
set logscale cb
set format cb "%.1le%L"

plot "pressure-deviations_tcA0.500000_tcB0.300000_aA0.562500_aAB0.397748_aB0.281250.dat" using 1:2:3 with points pointtype 7 pointsize 0.5 palette title "Pressure Deviations", \
