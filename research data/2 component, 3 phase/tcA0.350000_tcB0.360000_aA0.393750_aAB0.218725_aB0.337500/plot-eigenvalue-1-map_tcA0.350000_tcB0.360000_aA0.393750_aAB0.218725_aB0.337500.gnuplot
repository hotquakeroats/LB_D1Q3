...
set size square
set grid
stats "eigenstuff_tcA0.350000_tcB0.360000_aA0.393750_aAB0.218725_aB0.337500.dat" using 4
...
plot "eigenstuff_tcA0.350000_tcB0.360000_aA0.393750_aAB0.218725_aB0.337500.dat" using 1:2:($4<0 ? -1*log(abs($4)+1) : log(abs($4)+1)) with points pointtype 7 pointsize 1.5 palette title "Eigenvalue 1", \
