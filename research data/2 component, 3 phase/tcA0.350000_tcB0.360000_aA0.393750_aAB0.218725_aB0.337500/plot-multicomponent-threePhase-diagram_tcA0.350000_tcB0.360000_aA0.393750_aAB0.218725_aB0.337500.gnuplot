...
plot "threePhaseDiagram-densities-twoPhases_tcA0.350000_tcB0.360000_aA0.393750_aAB0.218725_aB0.337500.dat" using 1:2 with points pointtype 13 lc rgb 'light-grey' title "Minimization 2-phase Test Point", \
 ...
 "LB-two-phase-region_tcA0.350000_tcB0.360000_aA0.393750_aAB0.218725_aB0.337500.dat" using 1:2 with points pointtype 7 lc rgb 'blue' title "LB 2-phase region (log)", \
 "LB-metastable-2-phase-region_tcA0.350000_tcB0.360000_aA0.393750_aAB0.218725_aB0.337500.dat" using 1:2 with points pointtype 7 lc rgb 'green' title "LB metastable region (2-phase)", \
 "LB-three-phase-region_tcA0.350000_tcB0.360000_aA0.393750_aAB0.218725_aB0.337500.dat" using 1:2 with points pointtype 7 lc rgb 'gold' title "LB 3-phase region", \
