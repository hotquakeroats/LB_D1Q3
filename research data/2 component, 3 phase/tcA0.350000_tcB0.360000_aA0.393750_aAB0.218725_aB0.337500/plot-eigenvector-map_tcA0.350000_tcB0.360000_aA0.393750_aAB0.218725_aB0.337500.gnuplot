...
plot "eigenstuff_tcA0.350000_tcB0.360000_aA0.393750_aAB0.218725_aB0.337500.dat" using ($4<=0 ? $1 : 1/0):2:(scale*$6/vnorm($6,1)):(scale/vnorm($6,1)) with vectors lc rgb "red" notitle, \
 "eigenstuff_tcA0.350000_tcB0.360000_aA0.393750_aAB0.218725_aB0.337500.dat" using ($4>0 ? $1 : 1/0):2:(scale*$6/vnorm($6,1)):(scale/vnorm($6,1)) with vectors lc rgb "blue" notitle, \
 "eigenstuff_tcA0.350000_tcB0.360000_aA0.393750_aAB0.218725_aB0.337500.dat" using ($5<=0 ? $1 : 1/0):2:(scale*$7/vnorm($7,1)):(scale/vnorm($7,1)) with vectors lc rgb "red" notitle, \
 "eigenstuff_tcA0.350000_tcB0.360000_aA0.393750_aAB0.218725_aB0.337500.dat" using ($5>0 ? $1 : 1/0):2:(scale*$7/vnorm($7,1)):(scale/vnorm($7,1)) with vectors lc rgb "blue" notitle, \
