...
set size square
set grid
stats "eigenstuff_tcA0.350000_tcB0.360000_aA0.393750_aAB0.218725_aB0.337500.dat" using 3
...
plot "eigenstuff_tcA0.350000_tcB0.360000_aA0.393750_aAB0.218725_aB0.337500.dat" using 1:2:($3<0 ? -1*log(abs($3)+1) : log(abs($3)+1)) with points pointtype 7 pointsize 1.5 palette title "Determinant", \
