...
set size square
set grid
stats "eigenstuff_tcA0.400000_tcB0.450000_aA0.450000_aAB0.227542_aB0.460227.dat" using 5
...
plot "eigenstuff_tcA0.400000_tcB0.450000_aA0.450000_aAB0.227542_aB0.460227.dat" using 1:2:($5<0 ? -1*log(abs($5)+1) : log(abs($5)+1)) with points pointtype 7 pointsize 1.5 palette title "Eigenvalue 2", \
